  ...
  return (
    <section className="py-28 bg-[#FAF7F2]">
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-12">
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-left">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Para pacientes</h3>
                <p className="text-gray-600 text-sm mt-1 leading-relaxed">
        ...
        {/* CTA text */}
        <p className="mt-14 text-gray-700 max-w-xl mx-auto">
          Entre na lista de espera e seja um dos primeiros a saber quando o
          acesso for liberado
        </p>

        {/* Form */}
        <div className="mt-10 bg-white p-8 rounded-2xl shadow-lg border border-gray-100 text-left max-w-xl mx-auto">
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="flex items-center border border-gray-200 rounded-lg px-3 py-2 bg-gray-50 focus-within:ring-2 focus-within:ring-gray-200">
            ...
            <div>
              ...
              <div className="flex items-start border border-gray-200 rounded-lg px-3 py-2 bg-gray-50 focus-within:ring-2 focus-within:ring-gray-200">
